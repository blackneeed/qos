use crate::{fb::Framebuffer, flanterm::{flanterm_write, FlantermContext, flanterm_fb_init}};
...
impl FramebufferCLI {
    pub fn new(fb: Framebuffer) -> FramebufferCLI {
        FramebufferCLI { ft_ctx: unsafe { flanterm_fb_init(
            None,
            None,
            fb.addr as *mut u32,
            fb.width as usize,
    ...
    pub fn write_str(&mut self, string: &str) {
        unsafe { flanterm_write(self.ft_ctx, string.as_ptr(), string.len()); }
    }
}
